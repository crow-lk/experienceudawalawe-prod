...
class ComprehensiveExperienceSeederV2 extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        // Define all 22 experiences from experience.txt with comprehensive fields
        $experiences = [
            [
...
Here, dining becomes part of the night\'s rhythm. Each bite is tied to authentic roots and living stories, a reflection of the spirit of community and care for the land, traditions sustained under starlit skies of Udawalawe.',
            ...
            [
                ...
                'subtitle' => 'Simple Bites, Simple Pleasures',
                'type' => 'Culinary / Snacks',
...
Here, even light meals hold authentic roots and living stories — a reflection of community bonds, care for the soil, and the joy of sharing simple pleasures together.',
                ...
                'exclusions' => [
                    ['item' => 'Alcohol'],
                    ['item' => 'Full meals (available separately)']
                ],
                'accessibility_info' => 'Accessible seating available',
                'booking_policy' => 'Walk-in welcome, advance booking recommended for groups',
                'good_to_know' => 'Perfect for a light break between activities. Snacks are prepared fresh daily using seasonal ingredients.',
                'traveler_qa' => [
                    ['question' => 'Are snacks vegetarian?', 'answer' => 'Most options are vegetarian, with a few containing local seafood or meat.'],
                    ['question' => 'What drinks are available?', 'answer' => 'Ceylon tea, herbal teas, and local fruit drinks.'],
                    ['question' => 'Can I try different snacks?', 'answer' => 'Yes, we offer variety platters to sample multiple items.'],
                    ['question' => 'Is it spicy?', 'answer' => 'Some items have mild spice; we can adjust levels on request.']
                ],
                'is_published' => true,
                'sort_order' => 4,
            ...
            [
                ...
                'subtitle' => 'Elevated Moments, Grounded Flavors',
                'type' => 'Culinary / Unique Experience',
...
This is not just tea, but a pause in the day — a moment that blends authentic roots and living stories with a touch of tranquility, offering an experience as much about setting as it is about flavor.',
                ...
                'what_to_wear' => 'Comfortable walking shoes, casual clothing',
                'exclusions' => [
                    ['item' => 'Alcohol'],
                    ['item' => 'Transport to village (available separately)']
                ],
                'accessibility_info' => 'Requires climbing stairs to tree house; not suitable for mobility restrictions',
                'booking_policy' => '24-hour advance notice required',
                'good_to_know' => 'Weather-dependent experience. We provide alternative indoor setting during rain. Best enjoyed in late afternoon when light is soft.',
                'traveler_qa' => [
                    ['question' => 'Is it safe to eat in the tree house?', 'answer' => 'Yes, the tree house is secure with safety railings and stable platform.'],
                    ['question' => 'What if it rains?', 'answer' => 'We have a covered backup location with similar views.'],
                    ['question' => 'How high is the tree house?', 'answer' => 'About 12 feet high, accessible by sturdy wooden stairs.'],
                    ['question' => 'Can children participate?', 'answer' => 'Yes, children 6+ are welcome with adult supervision.']
                ],
                'is_published' => true,
                'sort_order' => 5,
            ...
            [
                ...
                'subtitle' => 'Romance Among the Branches',
...
This is more than dinner. It is a moment of connection — with each other, with the land, and with traditions sustained for generations. Every detail, from the ingredients on the plate to the glow of the lanterns above, ties you to authentic roots and living stories, making the evening unforgettable.',
                ...
                'group_size' => '2 guests (couples only)',
                'difficulty_level' => 'Easy',
                'base_price' => 120.00,
                'inclusions' => [
                ...
                'what_to_wear' => 'Smart casual, comfortable shoes for stairs',
                'exclusions' => [
                    ['item' => 'Alcohol (can be arranged separately)'],
                    ['item' => 'Photography services (available on request)']
                ],
                'accessibility_info' => 'Requires climbing stairs; not suitable for mobility restrictions',
                'booking_policy' => '48-hour advance booking required',
                'good_to_know' => 'Perfect for anniversaries, proposals, or special celebrations. Weather backup plan available. Dietary restrictions can be accommodated with advance notice.',
                'traveler_qa' => [
                    ['question' => 'Is this suitable for proposals?', 'answer' => 'Absolutely! We can help arrange special touches for proposals.'],
                    ['question' => 'What happens if it rains?', 'answer' => 'We have a romantic indoor backup with similar ambiance.'],
                    ['question' => 'Can we bring wine?', 'answer' => 'Yes, you can bring your own alcohol or we can arrange local options.'],
                    ['question' => 'Is photography included?', 'answer' => 'Basic photos can be arranged; professional photography available separately.']
                ],
                'is_published' => true,
                'sort_order' => 6,
            ...
            [
                ...
                'subtitle' => 'Living Heritage, Living Stories',
                'type' => 'Cultural',
...
This is not a staged performance but a sharing of life. Each moment carries authentic roots and living stories — connections to people, land, and traditions that thrive in Udawalawe.',
                ...
                'what_to_wear' => 'Comfortable clothes, closed shoes for activities',
                'exclusions' => [
                    ['item' => 'Meals (available separately)'],
                    ['item' => 'Professional photography']
                ],
                'accessibility_info' => 'Some activities require mobility; alternatives provided for those with limitations',
                'booking_policy' => 'Advance booking recommended; walk-ins subject to availability',
                'good_to_know' => 'Hands-on experience with traditional crafts. Tree climbing is optional and weather-dependent. Perfect introduction to Sri Lankan village culture.',
                'traveler_qa' => [
                    ['question' => 'Is tree climbing mandatory?', 'answer' => 'No, it\'s completely optional and we have alternatives for all activity levels.'],
                    ['question' => 'What age groups can participate?', 'answer' => 'All ages welcome; activities adapted for children and seniors.'],
                    ['question' => 'Do we keep the traditional clothes?', 'answer' => 'Clothes are provided for the experience; purchases can be arranged separately.'],
                    ['question' => 'Is it educational for children?', 'answer' => 'Yes, it\'s very educational with hands-on learning about traditional culture.']
                ],
                'is_published' => true,
                'sort_order' => 7,
            ...
            [
                ...
                'subtitle' => 'Tree of Life, Circle of Tradition',
...
This is not just a demonstration but a full story of resilience and ingenuity. Each step carries authentic roots and living stories — of a people who have relied on the coconut tree for nourishment, livelihood, and identity for generations.',
                ...
                'what_to_wear' => 'Comfortable clothes, closed shoes',
                'exclusions' => [
                    ['item' => 'Coconut products to take home (available for purchase)'],
                    ['item' => 'Refreshments (available separately)']
                ],
                'accessibility_info' => 'Ground-level activities suitable for most; tree climbing demonstration only',
                'booking_policy' => 'Advance booking recommended',
                'good_to_know' => 'Learn about sustainable use of natural resources. Perfect for understanding traditional Sri Lankan crafts and their modern relevance.',
                'traveler_qa' => [
                    ['question' => 'Do we get to climb trees?', 'answer' => 'You can try basic climbing techniques under supervision, but demonstration is main focus.'],
                    ['question' => 'What do we make?', 'answer' => 'Simple rope crafts and fiber products that you can take home.'],
                    ['question' => 'Is this suitable for children?', 'answer' => 'Yes, very educational for children 6+ with hands-on learning opportunities.'],
                    ['question' => 'Do we learn about coconut uses?', 'answer' => 'Yes, from food to crafts to building materials - all traditional uses are covered.']
                ],
                'is_published' => true,
                'sort_order' => 8,
            ...
            [
                ...
                'short_summary' => 'Discover Udawalawe\'s mining heritage through a model gem mine and dona tunnels. Learn traditional methods of digging, sifting, and washing before ending with a village touch of adventure.',
...
Here, the mine is not a spectacle but a lesson. Every step carries authentic roots and living stories, revealing how the soil sustains life not only through food but also through the hidden stones beneath.',
                'duration_label' => '1.5–2 hours',
                'group_size' => 'Individuals to large groups',
                'difficulty_level' => 'Easy',
                'base_price' => 40.00,
                'inclusions' => [
                    ['item' => 'Welcome drink'],
                    ['item' => 'Garden walk'],
                    ['item' => 'Mine & dona demonstration'],
                    ['item' => 'Traditional mining methods'],
                    ['item' => 'Optional coconut tree climbing'],
                    ['item' => 'Tree house pause']
                ],
                'what_to_wear' => 'Comfortable clothing, closed shoes recommended',
                'exclusions' => [
                    ['item' => 'Meals (can be added separately as lunch or dinner)']
                ],
                'accessibility_info' => 'Garden walk is easy; mine edge has uneven ground; tree house requires stairs',
                'booking_policy' => 'Advance booking recommended',
                'good_to_know' => 'This is an educational heritage experience, not a staged show or souvenir hunt. Expect real tools, clear explanations, and the chance to try small demonstrations guided by local hosts.',
                'traveler_qa' => [
                    ['question' => 'What is the dona?', 'answer' => 'The dona refers to tunnel-like passages inside the pit, used to reach gem-bearing layers and manage water and airflow.'],
                    ['question' => 'Is this a working mine?', 'answer' => 'No, this is a model site created for education and heritage preservation, not commercial extraction.'],
                    ['question' => 'How long does it take?', 'answer' => 'Around 1.5–2 hours, including welcome, garden walk, mine visit, and tree house pause.'],
                    ['question' => 'Is it safe?', 'answer' => 'Yes, activities are carefully guided, with demonstrations and supervised participation.'],
                    ['question' => 'Is it suitable for children?', 'answer' => 'Yes, with supervision, particularly around the mine pit.']
                ],
                'is_published' => true,
                'sort_order' => 9,
...
This is not just a culinary lesson but a story of place. Every step reflects authentic roots and living stories — of buffalo herders, clay pot makers, and families who continue this practice today with respect for land and tradition.',
                ...
                'inclusions' => [
                    ['item' => 'Demonstration'],
                    ['item' => 'Guest participation'],
                    ['item' => 'Curd tasting with kithul treacle']
                ],
                'what_to_wear' => 'Comfortable, light clothing (outdoor setting)',
                'exclusions' => [
                    ['item' => 'Meals (can be paired with Lunch or Village Experience)']
                ],
                'accessibility_info' => 'Fully accessible',
                'booking_policy' => 'Advance booking recommended',
                'good_to_know' => 'Curd is traditionally set for several hours before serving, so the pots made during your visit will not be ready to taste immediately. You will sample curd made earlier the same day while learning the process.',
                'traveler_qa' => [
                    ['question' => 'What milk is used?', 'answer' => 'Traditionally buffalo milk, prized for its richness and flavor.'],
                    ['question' => 'Do we get to taste it?', 'answer' => 'Yes, you will taste curd paired with kithul treacle.'],
                    ['question' => 'Is it hands-on?', 'answer' => 'Yes, guests can join in boiling, pouring, and sealing the pots.'],
                    ['question' => 'How long does it take?', 'answer' => 'About 1.5 hours (demonstration and tasting).'],
                    ['question' => 'Is it sustainable?', 'answer' => 'Yes, the process uses natural ingredients, clay pots, and traditional methods.']
                ],
                'is_published' => true,
                'sort_order' => 10,
            ...
            [
                ...
                'short_summary' => 'Discover the ancient craft of toddy tapping in Udawalawe. Watch how coconut or palmyrah sap is collected, learn its role in village life, and taste this natural drink the way locals do.',
...
This is more than a tasting. It is a glimpse into the fabric of local life, where trees give not only food but also livelihood and culture. Every step carries authentic roots and living stories — from the climb of the tapper to the first sip that connects you to a tradition as old as the village itself.',
                ...
                'base_price' => 25.00,
                'inclusions' => [
                    ['item' => 'Demonstration of toddy tapping'],
                    ['item' => 'Guided explanation'],
                    ['item' => 'Toddy tasting (fermented and/or fresh sap)'],
                    ['item' => 'Refreshments']
                ],
                'what_to_wear' => 'Comfortable clothing, light footwear',
                'exclusions' => [
                    ['item' => 'Meals (can be paired with Lunch, Dinner, or Village Experience)']
                ],
                'accessibility_info' => 'Fully accessible for observation and tasting',
                'booking_policy' => '24-hour advance notice recommended',
                'good_to_know' => 'Toddy is traditionally enjoyed fresh, within hours of tapping. Its taste varies depending on the tree, time of day, and fermentation. This is an educational, small-scale experience focused on heritage and cultural value, not on alcohol consumption.',
                'traveler_qa' => [
                    ['question' => 'What is toddy?', 'answer' => 'A natural drink made from the sap of coconut or palmyrah flowers, lightly fermented within hours of collection.'],
                    ['question' => 'Is it alcoholic?', 'answer' => 'Fresh toddy is mildly fermented (2–4%). Non-fermented tastings are available for those who prefer.'],
                    ['question' => 'Do we see the tapping live?', 'answer' => 'Yes, demonstrations include the collection process, explained by local hosts.'],
                    ['question' => 'Can guests climb?', 'answer' => 'For safety, climbing is done by trained hosts. Guests observe and handle equipment at ground level.'],
                    ['question' => 'How long is the experience?', 'answer' => 'About 1–1.5 hours, including demonstration, storytelling, and tasting.']
                ],
                'is_published' => true,
                'sort_order' => 11,
            ...
            [
                ...
                'type' => 'Cultural / Craft Heritage',
                'slug' => 'pottery-experience',
                'short_summary' => 'Shape clay with your own hands in Udawalawe\'s Pottery Experience. Learn how local artisans turn earth into vessels and discover a tradition rooted in daily life for generations.',
...
This is not just craft. It is a glimpse into how communities once lived in closer rhythm with their land, making what they needed with what the soil gave. Every turn of the wheel and every clay pot embodies authentic roots and living stories — the continuity of culture, resourcefulness, and creativity that still endures in Udawalawe.',
                ...
                'inclusions' => [
                    ['item' => 'Demonstration'],
                    ['item' => 'Hands-on clay shaping'],
                    ['item' => 'Small takeaway piece']
                ],
                'what_to_wear' => 'Comfortable clothes (clay can stain), open mindset to get your hands dirty',
                'exclusions' => [
                    ['item' => 'Meals (can be paired with Lunch or Village Experience)']
                ],
                'accessibility_info' => 'Seated activity, generally accessible',
                'booking_policy' => 'Advance booking recommended',
                'good_to_know' => 'Clay work can be messy — wear clothes you don\'t mind getting a little dirty. The focus is on learning and experiencing, not producing a perfect pot.',
                'traveler_qa' => [
                    ['question' => 'Do we get to make our own pot?', 'answer' => 'Yes, guests can try shaping a small pot or bowl under the guidance of local artisans.'],
                    ['question' => 'Is it suitable for children?', 'answer' => 'Yes, children enjoy hands-on clay shaping, though supervision is required.'],
                    ['question' => 'Do we get to keep what we make?', 'answer' => 'Small unfired pieces can be taken as mementos. Larger or fired pots are available for purchase.'],
                    ['question' => 'How long is the session?', 'answer' => 'About 1.5–2 hours, including demonstration and hands-on practice.'],
                    ['question' => 'Is it sustainable?', 'answer' => 'Yes, the clay is locally sourced and the process follows traditional low-impact methods.']
                ],
                'is_published' => true,
                'sort_order' => 12,
...
The loop covers about 14 kilometers; a moderate ride designed for those who enjoy fresh air and light activity. Children aged 13 and above can join comfortably. Every turn of the wheel carries authentic roots and living stories — tying you to the landscape, the people, and the simple beauty of moving with the day.',
                'duration_label' => 'Approx. 2½ hours',
                'group_size' => '2–8 guests',
                'difficulty_level' => 'Moderate',
                'base_price' => 35.00,
                'inclusions' => [
                    ['item' => 'Bicycle, helmet'],
                    ['item' => 'Guide/naturalist'],
                    ['item' => 'Snack']
                ],
                'what_to_wear' => 'Light, breathable clothes and good shoes',
                'exclusions' => [
                    ['item' => 'Meals, transport to meeting point']
                ],
                'accessibility_info' => 'Not suitable for wheelchairs or very young children',
                'booking_policy' => 'Advance booking required',
                'good_to_know' => 'We recommend this experience for children aged 13 and above. The focus is on gentle exploration and cultural connection, not speed or competition.',
                'traveler_qa' => [
                    ['question' => 'How long is the ride?', 'answer' => 'About 2½ hours, depending on group pace.'],
                    ['question' => 'Is it difficult?', 'answer' => 'Moderate — the loop is around 14 kilometers with plenty of breaks.'],
                    ['question' => 'Do we ride alone?', 'answer' => 'No, a guide or naturalist accompanies you throughout.'],
                    ['question' => 'What is included?', 'answer' => 'Bicycles, helmets, guiding, and a light snack.'],
                    ['question' => 'Is it suitable for kids?', 'answer' => 'Recommended for ages 13 and above.']
                ],
                'is_published' => true,
                'sort_order' => 13,
...
This visit is not about entertainment but about conservation. Every moment reflects authentic roots and living stories — a reminder that protecting elephants is part of protecting Sri Lanka\'s living heritage.',
                'duration_label' => '1.5–2 hours',
                'group_size' => 'Up to 5 per jeep (max 8 with additional 3 pax)',
                'difficulty_level' => 'Easy',
                'base_price' => 55.00,
                'inclusions' => [
                    ['item' => 'Entry tickets'],
                    ['item' => 'Guidance by naturalist/staff'],
                    ['item' => 'Snack']
                ],
                'what_to_wear' => 'Comfortable clothes, hat, sunscreen',
                'exclusions' => [
                    ['item' => 'Meals, transport unless arranged']
                ],
                'accessibility_info' => 'Viewing platform is accessible; seating available',
                'booking_policy' => 'Advance booking essential to secure entry',
                'good_to_know' => 'The Elephant Transit Home focuses on rehabilitation, not entertainment. Elephants are not kept for show or rides; they are released into the wild once ready. Visits are designed to support conservation efforts.',
                'traveler_qa' => [
                    ['question' => 'What does the experience include?', 'answer' => 'Entry tickets, guidance from a naturalist or staff member, and a snack.'],
                    ['question' => 'When is the best time to visit?', 'answer' => '6:00 p.m. is recommended, as it is quieter after safari hours.'],
                    ['question' => 'How many people can join?', 'answer' => 'A maximum of 5 persons per jeep (additional 3 pax only).'],
                    ['question' => 'Do we see elephants up close?', 'answer' => 'Calves are observed from a viewing platform during feeding for their safety.'],
                    ['question' => 'Is it family-friendly?', 'answer' => 'Yes, the Elephant Transit Home is suitable for children and educational for all ages.']
                ],
                'is_published' => true,
                'sort_order' => 14,
            ...
            [
                ...
                'short_summary' => 'Join local fishermen on the waters of Udawalawe and learn time-honored fishing techniques. End the day with your own fresh catch, prepared village-style to share and enjoy.',
...
Every cast, every story, every bite carries authentic roots and living stories, connecting you to the spirit of Udawalawe\'s waters and its people.',
                'duration_label' => 'Approx. 4 hours',
                'group_size' => '2–8 guests',
                'difficulty_level' => 'Easy',
                'base_price' => 65.00,
                'inclusions' => [
                    ['item' => 'Naturalist or staff host'],
                    ['item' => 'Local fisherman'],
                    ['item' => 'Transport'],
                    ['item' => 'Life jackets'],
                    ['item' => 'Village-style preparation of freshly caught fish']
                ],
                'what_to_wear' => 'Light, breezy clothes; hat and sunscreen recommended',
                'exclusions' => [
                    ['item' => 'Other meals or drinks not specified']
                ],
                'accessibility_info' => 'Boat trip requires basic mobility; bike-ride option available on land',
                'booking_policy' => 'Advance booking essential',
                'good_to_know' => 'Prefer to stay on land? This experience can also be arranged with a scenic bike ride in place of the boat trip. Just let us know your preference when booking.',
                'traveler_qa' => [
                    ['question' => 'Do I need prior fishing experience?', 'answer' => 'No, local fishermen guide you through the process.'],
                    ['question' => 'Is it safe?', 'answer' => 'Yes, life jackets are provided and boats are accompanied by staff.'],
                    ['question' => 'How long does it take?', 'answer' => 'Around 4 hours, including the fishing trip and meal.'],
                    ['question' => 'What if I don\'t want to go on the boat?', 'answer' => 'A land-based version with a bike ride can be arranged.'],
                    ['question' => 'Do we eat the fish we catch?', 'answer' => 'Yes, it is prepared village-style for you to enjoy.']
                ],
                'is_published' => true,
                'sort_order' => 15,
...
This is more than a walk — it is a way of seeing. Each footstep carries authentic roots and living stories, connecting you to Udawalawe\'s rhythms of land, wildlife, and community.',
                ...
                'base_price' => 20.00,
                'inclusions' => [
                    ['item' => 'Hotel naturalist or staff guide'],
                    ['item' => 'Light snack']
                ],
                'what_to_wear' => 'Light, airy, neutral-colored clothes and good walking shoes',
                'exclusions' => [
                    ['item' => 'Meals, transport unless arranged']
                ],
                'accessibility_info' => 'Easy terrain, but not wheelchair accessible',
                'booking_policy' => 'Advance booking recommended',
                'good_to_know' => 'We recommend starting at 6:00 a.m. or 4:00 p.m., when the air is cooler and wildlife sightings are more frequent.',
                'traveler_qa' => [
                    ['question' => 'How long is the walk?', 'answer' => 'About 2 hours.'],
                    ['question' => 'Is it difficult?', 'answer' => 'No, it is an easy walk suitable for most fitness levels.'],
                    ['question' => 'When is the best time?', 'answer' => '6:00 a.m. or 4:00 p.m. for the best wildlife sightings.'],
                    ['question' => 'Do we see wildlife?', 'answer' => 'Yes, birds, butterflies, and small mammals are commonly spotted.'],
                    ['question' => 'Is it family-friendly?', 'answer' => 'Yes, children can join with supervision.']
                ],
                'is_published' => true,
                'sort_order' => 16,
...
This is not a long trek but a meaningful step into a way of life. Each moment carries authentic roots and living stories — a reminder that sustainability here is not a concept but a lived reality, shared between neighbors, land, and wildlife.',
                ...
                'accessibility_info' => 'Easy terrain, generally accessible',
                'booking_policy' => 'Advance booking recommended',
                'good_to_know' => 'We recommend starting in the morning or evening for the most comfortable weather and the best chance to spot birds and butterflies.',
                'traveler_qa' => [
                    ['question' => 'How long is the walk?', 'answer' => 'About 1 hour.'],
                    ['question' => 'Is it difficult?', 'answer' => 'No, it is easy and suitable for all fitness levels.'],
                    ['question' => 'What do we see?', 'answer' => 'Birds, butterflies, community farming practices, and examples of sustainable living.'],
                    ['question' => 'When is the best time?', 'answer' => 'Morning or evening, when it is cooler and wildlife is more active.'],
                    ['question' => 'Is it family-friendly?', 'answer' => 'Yes, it is ideal for families and children.']
                ],
                'is_published' => true,
                'sort_order' => 17,
...
Whether you are an avid birder, a keen photographer, or simply someone seeking peace in nature, kayaking here is more than an activity. It is an immersion into Udawalawe\'s living landscape — authentic roots and living stories carried on the water\'s surface.',
                ...
                'base_price' => 25.00,
                'inclusions' => [
                    ['item' => 'Kayaks, life jackets'],
                    ['item' => 'Naturalist or staff guide']
                ],
                'what_to_wear' => 'Light, breezy clothes; sandals or water shoes',
                'exclusions' => [
                    ['item' => 'Meals, transport unless arranged']
                ],
                'accessibility_info' => 'Requires basic mobility to enter and exit the kayak',
                'booking_policy' => 'Best booked upon arrival due to fluctuating water levels',
                'good_to_know' => 'We recommend the experience for guests aged 15 and above. The water levels of the canals fluctuate seasonally, so please confirm availability when you arrive. Morning or evening departures are ideal for comfort and sightings.',
                'traveler_qa' => [
                    ['question' => 'How long is the experience?', 'answer' => 'Around 1 hour.'],
                    ['question' => 'Do I need experience?', 'answer' => 'No, it is suitable for beginners with full guidance.'],
                    ['question' => 'Is it safe?', 'answer' => 'Yes, kayaks are stable and life jackets are provided.'],
                    ['question' => 'Is it family-friendly?', 'answer' => 'Recommended for ages 15 and above.'],
                    ['question' => 'When is the best time?', 'answer' => 'Morning or evening, when it is cooler and birdlife is most active.']
                ],
                'is_published' => true,
                'sort_order' => 18,
            ...
            [
                ...
                'type' => 'Sustainability / Conservation',
                'slug' => 'tree-planting',
...
Every sapling planted here grows into more than a tree — it becomes a living story tied to authentic roots, a reminder that your journey through Udawalawe has contributed to a greener tomorrow.',
                ...
                'group_size' => 'Flexible (2–20 guests)',
                'difficulty_level' => 'Easy',
                'base_price' => 10.00,
                'inclusions' => [
                    ['item' => 'Guidance by staff or naturalist'],
                    ['item' => 'Sapling'],
                    ['item' => 'Tools'],
                    ['item' => 'Water']
                ],
                'what_to_wear' => 'Comfortable clothes, closed shoes; gloves provided if needed',
                'exclusions' => [
                    ['item' => 'Meals or transport unless arranged']
                ],
                'accessibility_info' => 'Fully accessible',
                'booking_policy' => 'Available year-round with advance notice',
                'good_to_know' => 'Tree planting is scheduled to match the weather and soil conditions for the best chance of survival. Saplings are monitored by the team as part of ongoing conservation work.',
                'traveler_qa' => [
                    ['question' => 'Do I need experience?', 'answer' => 'No, staff will guide you through every step.'],
                    ['question' => 'What kind of trees do we plant?', 'answer' => 'Native species suited to the local environment.'],
                    ['question' => 'How long does it take?', 'answer' => 'Around 30–45 minutes, depending on group size.'],
                    ['question' => 'Is it family-friendly?', 'answer' => 'Yes, ideal for children and groups.'],
                    ['question' => 'Is it sustainable?', 'answer' => 'Yes, all saplings are part of an ongoing reforestation initiative.']
                ],
                'is_published' => true,
                'sort_order' => 19,
...
This is not just about bathing, but about immersion in Udawalawe\'s living heritage. Every ripple in the water carries authentic roots and living stories, offering you a moment of peace, play, and presence.',
                'duration_label' => 'Approx. 1–1.5 hours',
                'group_size' => '2–12 guests',
                'difficulty_level' => 'Easy',
                'base_price' => 20.00,
                'inclusions' => [
                    ['item' => 'Village Walk'],
                    ['item' => 'Guided bathing experience'],
                    ['item' => 'Snack'],
                    ['item' => 'Staff host']
                ],
                'what_to_wear' => 'Light clothes; bring swimwear or clothes suitable for bathing, plus a towel',
                'exclusions' => [
                    ['item' => 'Transport unless arranged']
                ],
                'accessibility_info' => 'Requires basic mobility to enter/exit river',
                'booking_policy' => 'Advance booking required',
                'good_to_know' => 'The river spot is carefully chosen for safety and privacy. Snacks are simple but fresh, reflecting local flavors. Please dress modestly for the bathing portion in respect of village customs.',
                'traveler_qa' => [
                    ['question' => 'Is it safe?', 'answer' => 'Yes, the chosen river spot is safe for bathing and guided by staff.'],
                    ['question' => 'How long does it last?', 'answer' => 'About 1–1.5 hours including bathing and snack.'],
                    ['question' => 'Do I need to bring anything?', 'answer' => 'Just a change of clothes and a towel.'],
                    ['question' => 'Is it family-friendly?', 'answer' => 'Yes, children can join under supervision.'],
                    ['question' => 'Do we go straight to the river?', 'answer' => 'No, the experience begins with a guided Village Walk.']
                ],
                'is_published' => true,
                'sort_order' => 20,
...
This is more than a safari. Every encounter carries authentic roots and living stories, connecting you to Sri Lanka\'s living heritage of wildlife and wilderness.',
                'duration_label' => 'Approx. 4.5 hours',
                'group_size' => 'Up to 5 guests per jeep (8 with additional pax)',
                'difficulty_level' => 'Easy',
                'base_price' => 85.00,
                'inclusions' => [
                    ['item' => 'Naturalist or staff guide'],
                ...
                'what_to_wear' => 'Light, airy, neutral-colored clothes; hat, sunscreen, comfortable shoes',
                'exclusions' => [
                    ['item' => 'Meals, transport to Yala unless arranged']
                ],
                'accessibility_info' => 'Jeep accessible; not suitable for wheelchairs',
                'booking_policy' => 'Advance booking required due to park demand',
                'good_to_know' => 'Safaris start early morning (4:30 a.m.) or afternoon (1:30 p.m.) for the best sightings. Yala is a popular park, and at times visitation can be high. Please be patient and respectful, avoiding littering or disturbing the animals. Wildlife sightings are never guaranteed — that unpredictability is part of the wilderness experience.',
                'traveler_qa' => [
                    ['question' => 'How long is the safari?', 'answer' => 'About 4.5 hours.'],
                    ['question' => 'When does it start?', 'answer' => 'Morning safaris begin around 4:30 a.m.; evening safaris start at 1:30 p.m.'],
                    ['question' => 'How many people per jeep?', 'answer' => 'Maximum 5 persons (additional 3 pax only).'],
                    ['question' => 'What wildlife can we see?', 'answer' => 'Leopards, elephants, deer, buffalo, monkeys, wild boar, crocodiles, peacocks, and sometimes sloth bears.'],
                    ['question' => 'Is it suitable for families?', 'answer' => 'Yes, children are welcome with supervision.']
                ],
                'is_published' => true,
                'sort_order' => 21,
...
This is more than just an elephant safari. Every encounter carries authentic roots and living stories, connecting you to the wild heart of Udawalawe and the balance of nature it represents.',
                ...
                'what_to_wear' => 'Light, airy, neutral-colored clothes; hat, sunscreen, comfortable shoes',
                'exclusions' => [
                    ['item' => 'Meals, transport to Udawalawe unless arranged']
                ],
                'accessibility_info' => 'Jeep accessible; not suitable for wheelchairs',
                'booking_policy' => 'Advance booking required',
                'good_to_know' => 'Safaris start early morning (4:30 a.m.) or afternoon (1:30 p.m.), when animals are most active. While elephants are frequently seen, remember that all wildlife sightings are part of nature\'s rhythm and cannot be guaranteed. Please be respectful of the park: avoid littering, keep noise low, and never disturb the animals.',
                'traveler_qa' => [
                    ['question' => 'How long is the safari?', 'answer' => 'About 4.5 hours.'],
                    ['question' => 'When does it start?', 'answer' => 'Morning safaris begin around 4:30 a.m.; evening safaris start at 1:30 p.m.'],
                    ['question' => 'How many people per jeep?', 'answer' => 'Maximum 5 persons (additional 3 pax only).'],
                    ['question' => 'What wildlife can we see?', 'answer' => 'Elephants, buffalo, deer, jackals, crocodiles, wild boar, monkeys, and a wide variety of bird species.'],
                    ['question' => 'Is it suitable for families?', 'answer' => 'Yes, children are welcome with supervision.']
                ],
                'is_published' => true,
                'sort_order' => 22,
        ...
        $this->command->info('ComprehensiveExperienceSeederV2 completed! ' . count($experiences) . ' comprehensive experiences created with all detailed fields from experience.txt.');
    }
}