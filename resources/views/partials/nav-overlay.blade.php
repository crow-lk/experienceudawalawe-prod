<div id="nav-overlay" class="fixed inset-0 hidden bg-[#0f1012]/95 text-white z-[70]">
    <div class="absolute inset-0">
        <button type="button" data-overlay-close
            class="absolute top-4 right-4 rounded-full border border-white/30 p-3 text-white/80 hover:text-white hover:border-white hover:bg-white/10 transition-all duration-200">
    ...
    <div class="max-w-9xl mx-auto px-6 flex flex-col gap-12">
        <div class="w-auto grid grid-cols-2 relative z-10 h-full overflow-y-auto">
            ...
            <div class="social-icons flex justify-center gap-6 mt-20">
                ...
                <a href="#" class="text-white transition" aria-label="TripAdvisor">
                    <svg class="h-8 w-8" fill="currentColor" viewBox="0 0 24 24">
